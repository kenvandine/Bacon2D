...
Scene {
    ...
    function toLeft() {
        parallaxScene.scrollFactor -= 0.05;
        if (parallaxScene.scrollFactor <= 0)
    ...
    ImageLayer {
        ...
        horizontalStep: -10 * parallaxScene.scrollFactor
    ...
    ImageLayer {
        ...
        horizontalStep: -15 * parallaxScene.scrollFactor
    ...
    ImageLayer {
        ...
        horizontalStep: -20 * parallaxScene.scrollFactor
        layerType: Layer.Infinite
        tileWidth: 40
        tileHeight: 40
    }
    ...
    ImageLayer {
        ...
        horizontalStep: -23 * parallaxScene.scrollFactor
        layerType: Layer.Infinite
        tileWidth: 40
        tileHeight: 40
    }
